/**
 * GoFitness QR Code Generator (Pure JavaScript, Zero Dependencies, Offline Safe)
 * Based on the QR Code specification (ISO/IEC 18004:2006).
 */
(function(global) {
    'use strict';

    // --- QR Code Polynomial & Tables ---
    ...
    const QRUtil = {
        ...
        getErrorCorrectionPolynomial: function(errorCorrectLength) {
    ...
    // Public API
    const QRGenerator = {
        generateMatrix: function(text, errorCorrectLevel) {
            const ec = (errorCorrectLevel !== undefined && QRErrorCorrectLevel[errorCorrectLevel] !== undefined)
        ...
        drawToCanvas: function(canvas, text, options) {
            ...
            const margin = opts.margin !== undefined ? opts.margin : 12;
            const darkColor = opts.darkColor || '#000000';
            const lightColor = opts.lightColor || '#ffffff';
            const ec = opts.errorCorrectLevel || 'L';

            const qr = this.generateMatrix(text, ec);
            ...
            const cellSize = activeSize / count;
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = { QRGenerator, QRCodeModel, QRErrorCorrectLevel };
    }
